...
@ToString
@Entity
@Table(name = "SB_COR_COMMON_TEMP")
public class CommonTemp extends Auditable {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "COMMON_TEMP_SEQ")
	@SequenceGenerator(name = "COMMON_TEMP_SEQ", sequenceName = "SB_COR_COMMON_TEMP_SEQ", allocationSize = 1)
	private Long id;
